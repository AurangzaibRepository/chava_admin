...
<div class="row mb-3">
    ...
    <div class="col-4">
        {{Form::select('reminder', $reminder, '', ['class' => 'form-select'])}}
...
<div class="row mb-3">
    ...
    <div class="col-4">
        {{Form::select('priorities', $priorities, '', ['class' => 'form-select'])}}
        <span class="spn-error" id="error-priorities">Priority required</span>
    </div>
</div>
<div class="row mb-3">
    ...
    <div class="col-4">
        {{Form::text('time', '', ['class' => 'form-control', 'readonly' => 'readonly'])}}
...
<div class="row mb-3">
    ...
    <div class="col-4">
        {{Form::select('repeat', $repeat, '', ['class' => 'form-select'])}}
