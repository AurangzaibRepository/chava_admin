<ul class="ul-left-menu">
    <li>
        <a href="{{route('dashboard')}}" class="dashboard"> <i class="fas fa-chart-pie"></i> <span>Dashboard</span></a>
    </li>
    <li>
    ...
    <li>
        <a href="{{route('community')}}" class="community"><i class="fas fa-cog"></i><span>Manage Community</span></a>
    </li>
    <li>
